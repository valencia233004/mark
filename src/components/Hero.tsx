...
export default function Hero() {
  ...
  // Parallax: photo moves slower than text on scroll
    ...
    >
      ...
      <div className="relative mx-auto max-w-6xl w-full px-6 py-24 pt-28 md:pt-24">
        <div className="flex flex-col-reverse md:flex-row items-center gap-12 md:gap-16">
            ...
            >
              <a
                ...
                className={cn(
                  ...
                  "btn-press outline-none focus-visible:ring-2 focus-visible:ring-amber-500 focus-visible:ring-offset-2 focus-visible:ring-offset-warm-brown"
                )}
              >
                Get in touch
              </a>
              <a
                ...
                className={cn(
                  ...
                  "border-cream/30 text-cream hover:bg-cream hover:text-warm-charcoal btn-press outline-none focus-visible:ring-2 focus-visible:ring-cream focus-visible:ring-offset-2 focus-visible:ring-offset-warm-brown"
                )}
              >
                See how I work
              </a>
          ...
          {/* Right — profile photo + workflow graphic with slower parallax */}
          <motion.div
          ...
          >
            ...
            {/* Profile photo with floating/breathing animation */}
            <motion.div
