...
const testimonials = [
  {
    id: "testimonial-1",
    quote: "Placeholder — client testimonial coming soon.",
    name: "Client Name",
...
export default function Testimonials() {
  ...
  return (
    <section id="testimonials" ref={ref} className="py-20 md:py-28 bg-sand/40">
      <div className="mx-auto max-w-6xl px-6">
        ...
        {/* (#21 — staggered card animations matching Services/Work pattern) */}
              ...
              <Card className="border-border/70 bg-white card-lift">
                <CardContent className="p-6 sm:p-8">
                  ...
                  <div className="mt-5 pt-4 border-t border-border/50">
                    <p className="font-[family-name:var(--font-display)] font-semibold text-warm-charcoal">
                      {t.name}
                    </p>
                    <p className="text-sm text-warm-gray-light">{t.business}</p>
                  </div>
                </CardContent>
              </Card>
            </motion.div>
